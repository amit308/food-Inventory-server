...
router.route('/addRestItem/:id').post(checkToken, controller.addRestItem);
router.route('/updateRestItem/:id').put(checkToken,controller.updateRestItem);
...
router.route('/addRestCategory/:id').post(checkToken, controller.addRestCategory);
...
router.route('/updateRestCategory/:id').put(checkToken,controller.updateRestCategory);
